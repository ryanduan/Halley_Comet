...
$(document).ready(function(e) {
    ...
    $('.share').SmohanPopLayer({Shade : true,Event:'click',Content : 'Share', Title : '分享本网址到'});
...
var share_pic = "/static/t.jpg";  //默认的分享图片
var share_from = encodeURIComponent("Halley_Comet官方网站"); //分享自（仅用于QQ空间和朋友网，新浪的只需更改appkey 和 ralateUid就行）
//Qzone
...
window.open('http://www.kaixin001.com/repaste/bshare.php?rtitle='+share_title+'&rurl='+share_url+'&from=Halley_Comet','newwindow');	
}); 
});
/*加入收藏*/
function addfavorite(){
  var Url = "http://127.0.0";
  var Title = "localhost";
  if(document.all){
